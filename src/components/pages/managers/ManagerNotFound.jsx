        ...
        <div className="bg-white rounded-lg border border-gray-200 p-8 md:p-12">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              We couldn't locate the manager you're looking for. The game may have been removed, or the ID might be incorrect.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex items-start">
                ...
                <span>Double-check the manager ID or search parameters</span>
              </li>
              <li className="flex items-start">
                <span className="text-gray-400 mr-2">•</span>
                <span>Verify that the manager hasn't been deactivated or removed</span>
              </li>
              <li className="flex items-start">
                <span className="text-gray-400 mr-2">•</span>
                <span>Try searching from the manager directory. Click <span onClick={() => window.location.href = '/managers'} className='font-bold cursor-pointer'>here</span> to view all managers</span>
              </li>
            </ul>
          </div>
